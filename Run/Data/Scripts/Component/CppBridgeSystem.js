...
//      */
//     render() {
//         // === DEBUG LOG: CppBridgeSystem render ===
//         console.log(`[CppBridgeSystem] Frame ${this.frameCount}: ENTERED render() - Priority 0 (renders FIRST)`);
//
...
//         }
//
//         console.log(`[CppBridgeSystem] Frame ${this.frameCount}: shouldRender = ${shouldRenderValue}`);
//
//         // Render C++ engine in all game states (ATTRACT and GAME modes)
//         // JavaScript entities are rendered separately by JSGame.gameRender()
//         if (shouldRenderValue && this.engine) {
//             console.log(`[CppBridgeSystem] Frame ${this.frameCount}: CALLING engine.renderCppEngine() - This renders ALL C++ content including debug text buffer`);
//             this.engine.renderCppEngine();
//             console.log(`[CppBridgeSystem] Frame ${this.frameCount}: engine.renderCppEngine() COMPLETED`);
//         }
//         else {
//             console.log(`[CppBridgeSystem] Frame ${this.frameCount}: SKIPPING renderCppEngine - shouldRender = ${shouldRenderValue}, engine = ${!!this.engine}`);
//         }
//     }
//
//     /**
